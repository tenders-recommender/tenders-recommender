...
def make_plot():
    ...
    traces = []
    for index, value in enumerate(complete_df['param_init_std_dev'].unique()):
        value_df = complete_df[complete_df['param_init_std_dev'] == value]
    ...
    pio.write_image(fig, 'svd_init_std_dev_comparison.svg')
