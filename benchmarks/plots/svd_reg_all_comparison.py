...
def make_plot():
    ...
    complete_df = complete_df[complete_df['param_n_factors'] == 50]
    ...
    traces = []
    for index, value in enumerate(complete_df['param_reg_all'].unique()):
        value_df = complete_df[complete_df['param_reg_all'] == value]
    ...
    pio.write_image(fig, 'svd_reg_all_comparison.svg')
