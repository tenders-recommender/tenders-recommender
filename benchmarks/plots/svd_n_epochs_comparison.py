...
def make_plot():
    ...
    traces = []
    for index, value in enumerate(complete_df['param_n_epochs'].unique()):
        value_df = complete_df[complete_df['param_n_epochs'] == value]
    ...
    pio.write_image(fig, 'svd_n_epochs_comparison.svg')
