...
def make_plot():
    ...
    traces = []
    for index, value in enumerate(complete_df['param_biased'].unique()):
        value_df = complete_df[complete_df['param_biased'] == value]
    ...
    pio.write_image(fig, 'svd_biased_comparison.svg')
