...
def make_plot():
    ...
    traces = []
    for index, value in enumerate(complete_df['param_lr_all'].unique()):
        value_df = complete_df[complete_df['param_lr_all'] == value]
    ...
    pio.write_image(fig, 'svd_lr_all_comparison.svg')
