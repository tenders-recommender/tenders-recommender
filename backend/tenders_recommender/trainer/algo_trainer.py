...
class AlgoTrainer(object):
    @staticmethod
    def train(train_set: Trainset,
              test_set: Testset,
              algorithm: AlgoBase) -> List[Prediction]:
        AlgoTrainer.__train_algorithm(algorithm, train_set)
        return AlgoTrainer.__calculate_all_predictions(algorithm, test_set)
    ...
    @staticmethod
    def __calculate_all_predictions(algorithm: AlgoBase, test_set: Testset) -> List[Prediction]:
